...
async function testV4Secret() {
    const method = 'GET';
    const path = `/v2/providers/openapi/apis/api/v4/ad-service/reports/summary/customer/${customerId}`;
    ...
    console.log(`Calling Secret Path: ${url}`);
    try {
